 ...
 * 
 */
@WebServiceClient(name = "NotificationConsumerService", targetNamespace = "http://docs.oasis-open.org/wsn/bw-2", wsdlLocation = "file:/C:/Projects/WeSN/trunk/Product/Production/WesnEjb/src/conf/xml-resources/web-services/NotificationProducerService/wsdl/WSN.wsdl")
public class NotificationConsumerService
    extends Service
{

    private final static URL NOTIFICATIONCONSUMERSERVICE_WSDL_LOCATION;
    private final static Logger logger = Logger.getLogger(org.oasis_open.docs.wsn.bw_2.NotificationConsumerService.class.getName());

    static {
        URL url = null;
        try {
            URL baseUrl;
            baseUrl = org.oasis_open.docs.wsn.bw_2.NotificationConsumerService.class.getResource(".");
    ...
    public NotificationConsumerService() {
        super(NOTIFICATIONCONSUMERSERVICE_WSDL_LOCATION, new QName("http://docs.oasis-open.org/wsn/bw-2", "NotificationConsumerService"));
    }
